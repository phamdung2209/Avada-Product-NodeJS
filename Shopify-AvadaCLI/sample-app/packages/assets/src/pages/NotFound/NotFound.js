    ...
    return (
        <Page title="Not Found" primaryAction={{content: 'Back to Home', url: '/'}}>
            <Layout sectioned>
                ...
                >
                    There is a technical problem with Avada that has prevented this page from
                    loading. Try reloading this page or going to another page in Avada. If that does
                    not work, please contact to use to support.
                </EmptyState>
            </Layout>
        </Page>
    );
